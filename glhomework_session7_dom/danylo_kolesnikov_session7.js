...
// intresting2.comment :
// var        message = '          LLLLLL\n          LLLLLL\n   GGGGGGGGGGGGL\n  GGGGGGGGGGGGGG\n GGGGGGGGGGGGGGGG \nGGGGGGG   LLLLGGG          \u2192\nGGGGGGG   LLLLLL           \u2192\u2192    Congrats!\nGGGGGG    LLLLLL           \u2192\u2192\u2192   More fun with command line\nGGGGGG    LLGGGG           \u2192\u2192    http://uni.xkcd.com/\nGGGGGGG   LGGGGGG          \u2192\nGGGGGGG   LLLLGGG\n GGGGGGGGGGGGGGGG\n  GGGGGGGGGGGGGG\n   GGGGGGGGGGGGL        LLL\n          LLLLLLLLLLLLLLLLL\n          LLLLLLLLLLLLLLLLL\n'.split(''),        i = message.length,        output = [],        colors = [];message.reverse();while (i--) {    output.push('%c' + message[i]);    if (message[i] === 'G') {        colors.push('color: RoyalBlue');    } else if (message[i] === '\u2192') {        colors.push('color: SeaGreen');    } else if (message[i] === 'L') {        colors.push('color: FireBrick');    } else {        colors.push('');    }}console.log.apply(console, [output.join('')].concat(colors));
function finally(string){
	var message = '          LLLLLL\n          LLLLLL\n   GGGGGGGGGGGGL\n  GGGGGGGGGGGGGG\n GGGGGGGGGGGGGGGG \nGGGGGGG   LLLLGGG          \u2192\nGGGGGGG   LLLLLL           \u2192\u2192    Congrats!\nGGGGGG    LLLLLL           \u2192\u2192\u2192   More fun with command line\nGGGGGG    LLGGGG           \u2192\u2192    http://uni.xkcd.com/\nGGGGGGG   LGGGGGG          \u2192\nGGGGGGG   LLLLGGG\n GGGGGGGGGGGGGGGG\n  GGGGGGGGGGGGGG\n   GGGGGGGGGGGGL        LLL\n          LLLLLLLLLLLLLLLLL\n          LLLLLLLLLLLLLLLLL\n'.split(''),
	    i = message.length,
	    output = [],  
	    colors = [];
